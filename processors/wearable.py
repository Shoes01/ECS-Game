    ...
    def process(self):
        while not self.queue.empty():
            ...
            if not item:
                ...
                elif self.world.has_component(item, JobReqComponent) and self.world.component_for_entity(ent, JobComponent) not in self.world.component_for_entity(item, JobReqComponent).job_req:
